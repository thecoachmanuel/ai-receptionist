    ...
    business_offerings: clamp(
      offerings
        .map((offering: any) => {
          ...
          const formattedPrice = `${numberToWords(amount)} Naira (₦${amount.toLocaleString("en-NG")})`;
